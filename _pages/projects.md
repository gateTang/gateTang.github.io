...
<div style="display: flex; flex-direction: column; gap: 12px; margin-top: 20px;">
  ...
  <!-- <a href="/ooo_processor_sim/" style="display: flex; align-items: center; justify-content: space-between; padding: 1rem 1.25rem; background: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 8px; text-decoration: none; transition: background-color 0.2s;">
    <div>
